    ...
    open override func viewDidLayoutSubviews() {
        ...
        if let button = locationButton {
            button.frame.origin = CGPoint(
                x: view.frame.width - button.frame.width - 30,
                y: view.frame.height - button.frame.height - 50
            )
        }
...
extension LocationPickerViewController: MKMapViewDelegate {
    public func mapView(_ mapView: MKMapView, viewFor annotation: MKAnnotation) -> MKAnnotationView? {
        ...
        pin.pinTintColor = UIColor.BeautyBell.accent
    ...
    func selectLocationButton() -> UIButton {
        ...
        button.setTitleColor(UIColor.BeautyBell.accent, for: UIControl.State())
