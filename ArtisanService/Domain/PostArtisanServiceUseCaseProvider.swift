//
//  PostArtisanServiceUseCaseProvider.swift
//  ArtisanService
//
...
public struct PostArtisanServiceUseCaseProvider<CloudService: ServiceType, Provider: Cache, ServiceRequest: Editable>: UseCase
    where
    CloudService.R == ServiceRequest, CloudService.T == ArtisanServiceDetail, CloudService.E == Error,
    Provider.R == ServiceRequest, Provider.T == ArtisanService {
        ...
        return _service
            ...
            .do(onNext: { result in
                ...
                case let .success(result):
                    if let detail = result.data?.service {
                        if request?.id != nil {
